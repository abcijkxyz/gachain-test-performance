...
class WebsiteTasks(TaskSet):
    ...
    # @task(2)
    # def new_mine(self):
    #     contract_name = 'NewMineInfo'
    #     url = "http://127.0.0.1:7079/api/v2"
    #     prk = "21234217f8d1f47ac4963d7006ad6c0feb3f9733f6d09029c61c240d77e307e6"
    #     token = actions.login(url, prk, 0)['jwtToken']
    #     redata = {'Number': data["Recipient"],
    #               'Name': '1000000000000',
    #               }
    #     contract = Contract(schema=schema, private_key=data["pr_key"],
    #                         params=redata)
...
class WebsiteUser(HttpLocust):
    ...
    for count in range(500):
        data = {
            ...
            "no" : count,
            "url": host,
            "pr_key" : TestSystemContracts().catche_read('wall1000.txt', 'pr_key')[random.randint(0, 2400)],
            "Recipient" : TestSystemContracts().catche_read('wall2000.txt','address')[random.randint(0, 2400)],
        }
